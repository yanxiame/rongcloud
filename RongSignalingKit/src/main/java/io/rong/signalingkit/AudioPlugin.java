...
public class AudioPlugin implements IPluginModule, IPluginRequestPermissionResultCallback {
    ...
    private void startAudioActivity(Fragment currentFragment, final RongExtension extension) {
        ...
        if (conversationType.equals(Conversation.ConversationType.PRIVATE)) {
            Intent intent = new Intent(RCSVoIPIntent.RONG_INTENT_ACTION_VOIP_SINGLEAUDIO);
            ...
            Log.i(TAG, "---- callAction=" + RCSCallAction.ACTION_OUTGOING_CALL.getName());
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Intent intent = new Intent(RCSVoIPIntent.RONG_INTENT_ACTION_VOIP_MULTIAUDIO);
