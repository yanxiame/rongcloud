...
@ProviderTag(
        messageContent = cn.sa.im.ui.widget.plugin.InsertMessage.class,
        showReadState = true
)
public class InsertItemProvider extends IContainerItemProvider.MessageProvider<cn.sa.im.ui.widget.plugin.InsertMessage> {
    ...
    @Override
    public void bindView(View view, int i, cn.sa.im.ui.widget.plugin.InsertMessage insertMessage, UIMessage message) {
        //根据需求，适配数据
    ...
    @Override
    public Spannable getContentSummary(cn.sa.im.ui.widget.plugin.InsertMessage redPackageMessage) {
        return null;
    }

    @Override
    public void onItemClick(View view, int i, cn.sa.im.ui.widget.plugin.InsertMessage redPackageMessage, UIMessage uiMessage) {
...
//        });
    ...
    @Override
    public void onItemLongClick(final View view, int i, cn.sa.im.ui.widget.plugin.InsertMessage redPackageMessage, UIMessage uiMessage) {
